...
async function main() {
  ...
  const urls = ["/","/anagram-solver","/word-finder","/wordle-solver","/dictionary-checker","/random-word-generator","/word",...staticWordList.map((word)=>`/word/${word}`),...seoListPages.map((page)=>page.url),"/word-game-cheat-sheet","/blog",...articles.map(a=>`/blog/${a.slug}`),"/about","/contact","/privacy","/terms","/sitemap"];
